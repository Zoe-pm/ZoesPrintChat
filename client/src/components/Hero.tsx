...
export default function Hero() {
  return (
    <section className="pt-32 pb-20 md:pt-40 md:pb-32 px-6 relative bg-gradient-to-r from-primary to-purple-500 text-white overflow-hidden">
      ...
      {/* Decorative elements */}
      <div className="absolute top-20 right-10 w-20 h-20 rounded-full bg-white/15 animate-bounce"></div>
      <div className="absolute bottom-40 left-10 w-12 h-12 rounded-full bg-white/15 animate-bounce delay-1000"></div>
      <div className="absolute top-40 left-20 w-8 h-8 rounded-full bg-white/15 animate-bounce delay-500"></div>
