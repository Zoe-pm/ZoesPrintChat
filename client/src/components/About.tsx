...
import { faCheck, faLock, faCoins, faCode } from "@fortawesome/free-solid-svg-icons";
...
export default function About() {
  const benefits = [
    ...
    },
    {
      icon: faCoins,
      title: "Faire Preise",
      description: "Langfristig planbar, keine Abo-Falle"
    },
    {
      icon: faCode,
      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="rounded-2xl overflow-hidden shadow-xl bg-gradient-to-br from-pink-100 to-purple-100 p-8">
                <div className="text-center">
                  ...
                  <h3 className="font-heading font-bold text-2xl mb-4">Für wen ist das was?</h3>
                  <ul className="space-y-3 text-left">
                    <li className="flex items-start">
                      <span className="text-pink-500 mr-2">•</span>
                      <span>Selbstständige & Coaches, die mehr Zeit für ihre Kund:innen wollen</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-pink-500 mr-2">•</span>
                    ...
                    <li className="flex items-start">
                      <span className="text-pink-500 mr-2">•</span>
                      <span>Kreative, Dienstleisterinnen & alle, die smart wachsen wollen – mit einem charmanten Chatbot an ihrer Seite</span>
                    </li>
                  </ul>
          ...
          <div>
            ...
            <div className="text-lg text-primary font-medium mb-6">Hey du! Schön, dass du da bist. ✨</div>
            <p className="text-gray-600 mb-4">
              Ich bin Zoe – Beraterin für clevere KI-Lösungen mit Persönlichkeit. Ich baue maßgeschneiderte Chatbots, die dein Team entlasten, deine Kunden begeistern und dir Zeit sparen – ganz ohne Hokuspokus.
            </p>
            <p className="text-gray-600 mb-6">
              Ob Terminbuchung, Kundenservice, interne Prozesse oder einfach smarte Unterstützung rund um die Uhr:
              Meine Chatbots sind wie kleine digitale Assistentinnen – freundlich, effizient und genau auf dich abgestimmt.
            </p>
            
            <h3 className="font-heading font-bold text-xl text-gray-800 mb-4">Was macht meine Chatbots besonders? 💬💕</h3>
            ...
            <div className="text-center sm:text-left">
              ...
              <p className="mt-4 text-sm text-gray-500">
                <span className="font-medium">🌟 KI kann klug & freundlich sein – lass uns das gemeinsam zeigen 🌟</span>
              </p>
            </div>
          </div>
        </div>
